...
// For Loop is lot more common and frequently used in programing then While and Do while, where as there might be situations where there is senario that we need to have while and do while loop, when we need the iteration to first do then check the condition. 
